...
<div class="container">
	<h1>添加抄表员</h1>
	<hr>
	<s:form action="person-save" method="post" theme="simple" class="form-horizontal">
		<div class="form-group">
			<label class="col-sm-2 control-label">用户名</label>
			<div class="col-sm-10">
				<input class="form-control" name="username" id="focusedInput" type="text" value="请输入用户名。。。。">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">密码</label>
			<div class="col-sm-10">
				<input class="form-control" name="password" id="focusedInput" type="password" value="请输入密码。。。。">
			</div>
		</div>
		<div class="form-group">
