...
<div class="container">
	<h1>添加水量</h1>
	<hr>
	<s:form action="roomwater-save" method="post" theme="simple" class="form-horizontal">
		<div class="form-group">
			<label class="col-sm-2 control-label">水量</label>
			<div class="col-sm-10">
				<input class="form-control" name="water" id="focusedInput" type="text" value="请输入水量。。。。">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">抄表周期</label>
			<div class="col-sm-10">
				<input class="form-control" name="date" id="focusedInput" type="text" value="请输入抄表周期。。。。">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">宿舍</label>
			<div class="col-sm-10">
				<s:select list="#request.room" listKey="id" listValue="room" name="tbRoom.id" label="宿舍">
				</s:select>
			</div>
		</div>
		<div class="form-group">
